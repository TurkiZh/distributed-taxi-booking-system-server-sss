...
public abstract class BookingState {
     ...
     * @throws IllegalArgumentException Invalid time. 
     *              Start time cannot be before booking creation timestamp.
     */
     ...
     *              Invalid time. Start time cannot be before booking creation timestamp.
     */
