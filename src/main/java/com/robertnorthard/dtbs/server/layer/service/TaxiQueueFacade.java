...
/**
 * An interface for defining and enforcing operations needed for the Taxi queue
 * class. It provides the scope of possible database requests made through the
 * AccountDAO.
 *
